  ...
  btns.forEach((btn) => {
    btn.addEventListener("click", function (e) {
      if (e.target.classList.contains(`${imgName}__btnlft-img`)) {
        ...
        img.src = `assets/particular_product_images/image-product-${nextImg + 1}.jpg`;
      }
...
function closeMenu() {
  ...
  menuBtnImg.src = "assets/particular_product_images/icon-menu.svg";
}
...
function openMenu() {
  ...
  menuBtnImg.src = "assets/particular_product_images/icon-close.svg";
...
overlayImgBtn.forEach((btn, i) => {
  btn.addEventListener("click", function (e) {
    overlayImg.src = `assets/particular_product_images/image-product-${i + 1}.jpg`;
...
imgBtn.forEach((btn, i) => {
  btn.addEventListener("click", function () {
    img.src = `assets/particular_product_images/image-product-${i + 1}.jpg`;
  });
});
